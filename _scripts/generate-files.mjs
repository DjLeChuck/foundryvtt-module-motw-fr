...
const compendiumLabels = {
  ...
  'the-expert': 'L’Expert',
  'the-flake': 'Le Parano',
  'the-gumshoe-tom': 'Le Détective [ToM]',
  'the-hex-tom': 'Le Lanceur de Sorts [ToM]',
  'the-initiate': 'L’Initié',
  'the-monstrous': 'Le Monstre',
  'the-mundane': 'L’Ordinaire',
  'the-paromantic-tom': 'Le Pararomantique [ToM]',
  'the-professional': 'Le Professionnel',
  'the-searcher-tom': 'Le Chercheur [ToM]',
  'the-snoop-he': 'Le Fureteur [HE]',
  'the-spell-slinger': 'Le Magicien',
  'the-spooktacular-he': 'Le Spectaculaire de l’Épouvante [HE]',
